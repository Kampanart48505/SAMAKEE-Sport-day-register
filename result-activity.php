				...
				<div class="panel-body">
					...
					<div class="row">
						...
						<div class="col-xl-11 col-7 mt-xl-4 mt-xs-2">
                            <h5>โรงเรียนยุพราชวิทยาลัย ปีการศึกษา 2563 ภาคเรียนที่ 1</h5>
                            <h5>สำนักงานเขตพื้นที่การศึกษามัธยมศึกษา เขต 34</h5>
                            <h5>รายชื่อนักเรียนกิจกรรมพัฒนาผู้เรียน (ชุมนุม) ภาคเรียนที่ 1 ปีการศึกษา 2563</h5>
						</div>
					</div>
					
                    <hr>
                    <p style="font-size: 15px"><b class="text-pink">ชื่อกิจกรรมชุมนุม : &nbsp;</b><?php echo $row['a_name']?></p>
					<p style="font-size: 15px"><b class="text-pink">ครูผู้สอน : &nbsp;</b><?php echo $row['a_teacher']?></p>
					<p style="font-size: 15px"><b class="text-pink">สถานที่เรียน : &nbsp;</b><?php echo $row['a_detail']?></p>
