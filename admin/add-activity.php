		...
		<div id="content" class="content">
			...
			<div class="panel panel-inverse">
				<div class="panel-heading ">
                    <h4 class="panel-title">เพิ่มกีฬา</h4>
				...
				<div class="panel-body">
                    ...
                    ?>
                    <form action="process/add-activityact.php" method="post">

                    <div class="form-group row m-b-15 d-none">
							<label class="col-form-label col-md-2">ไอดีคนเพิ่ม</label>
								<div class="col-md-10">
						...
						<div class="form-group row m-b-15">
							<label class="col-form-label col-md-2">ชื่อกีฬา</label>
								<div class="col-md-10">
									<input type="text" class="form-control m-b-5" placeholder="ชื่อกีฬา" name="a_name" id="a_name">
                        ...
                        <div class="form-group row m-b-15">
							<label class="col-form-label col-md-2">จำนวนที่รับ</label>
								<div class="col-md-10">
									<input type="text" class="form-control m-b-5" placeholder="จำนวนที่รับ" name="a_many" id="a_many">
                        ...
                        <input type="submit" class="btn btn-green" style="color: white;font-weight:unset" name="submit" value="เพิ่มกีฬา">
